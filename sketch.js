...
function setup() {
  ...
  background1 = createSprite(-400,400,800,1000)
  background1.shapeColor = "White"
  background2 = createSprite(1200,400,800,1000)
  background2.shapeColor = "White"
  background3 = createSprite(400,-400,10000,800)
  background3.shapeColor = "White"
  background4 = createSprite(400,1200,10000,800)
  background4.shapeColor = "White"
}
...
function draw() {
  ...
  if (gameState === "play") {
   ...
   camera.x = block.x
    ...
    if (((mousePressedOver(pause) )|| keyDown ("p"))&& (gameState = "play")) {
      gameState = "pause"
